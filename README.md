...
_**May 11, 2021:** Note that because of the Swift bug [SR-14578](https://bugs.swift.org/browse/SR-14578) you have to choose a Swift toolchain for Windows from the Snapshots, which could contain some other errors, as it is not as thoroughly tested as the releases. With Swift version 5.5 this will be resolved soon._
